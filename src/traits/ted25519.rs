...
impl GroupHasher for vsss_rs::curve25519_dalek::ristretto::RistrettoPoint {
    fn hash_to_curve(msg: &[u8]) -> Self {
        vsss_rs::curve25519_dalek::ristretto::RistrettoPoint::hash_from_bytes::<sha2::Sha512>(msg)
    }
}
...
impl ReduceWide<64> for vsss_rs::curve25519_dalek::Scalar {
